...
export default function WelcomeScreen() {
  ...
  const handleNavigate = (role: UserRole) => {
    router.push({ pathname: '/identity-verification', params: { role } });
  };
  ...
  return (
    <ScrollView
      ...
      contentContainerStyle={[
        styles.container,
        { paddingTop: insets.top + AppSpacing.xl, paddingBottom: insets.bottom + AppSpacing.lg },
      ]}
    >
      ...
      <Text style={styles.subtitle}>Secure biometric access for everyone</Text>
      ...
      >
        <Text style={styles.primaryButtonText}>Employee Access</Text>
      ...
      >
        <Text style={styles.secondaryButtonText}>Visitor Check-in</Text>
      ...
      <Text style={styles.footerText}>
        ...
        <Text style={styles.footerLink}>Security Policies</Text>
      </Text>
    </ScrollView>
  );
}
